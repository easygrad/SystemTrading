def errors(err_code):
    err_dic = {0:("OP_ERR_NONE","정상처리"),
              ...
              -311:("OP_ERR_/////", "주문전송제한 과부하하"),
              -340:("OPERR_ORD_WRONG_ACCTINFO", "계좌정보없음"),
